...
{
    int i;
    char s1[]="\xdb\xdb SELAMAT - DATANG \xdb\xdb";
    char s2[]="TEKAN TOMBOL APA SAJA UNTUK MELANJUTKAN";
    char s3[]="Game puzzle 2048";

    char s5[]="SELAMAT-DATANG DI 2048 GAME 'C'";

    char t[]="THIS PROJECT WAS CREATED BY ASTROBOX";
    char t1[]="For more projects";
    char t2[]="visit";
    char t3[]="github.com/astro13ox";
    ...
    system("cls");
    printf("\n\n\n\t\t\tINSTRUCTION\n\n\n");
    printf(" ->  Masukkan tombol panah untuk bergerak\n\n");
    printf(" ->  Untuk memenangkan game ini setiap kotak memiliki nilai 2048\n\n");
    printf(" -> Anda memiliki maksimum 2048x untuk memenangkan permainan\n\n\n\n");
...
void record(){
  ...
  fprintf(info,"Played Date:%s",ctime(&mytime));
   ...
   fprintf(info,"\n");
   fclose(info);
   printf("Ingin melihat record tekan 'y'\n");
   cha=getch();
   system("cls");
   if(cha=='y'){
...
main()
{
    int aro;
    char Arrow;
    char s[]="TERIMA KASIH SUDAH BERMAIN, GOOD LUCK FOR NEXT TIME ";
    int temp;
    starting();
    Starting_Random();
    Arrow=DOWN;
